...
Grid dimensions are determined by shape of the input 2D ndarray. Elements of the input 2D array are images specified by ndarrays with shape ``(n, m)`` or ``(n, m, 3)`` or ``(n, m, 4)``.
...
.. image:: assets/imagematrix_1.png
    :width: 400
...
.. image:: assets/imagematrix_2.png
    :width: 400