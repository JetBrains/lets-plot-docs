.. raw:: html
	...
	<thead><tr><td colspan="3">Brown colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Red colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Orange colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Yellow colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Green colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Cyan colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Blue colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Violet colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Purple colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Rose colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Very light colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
	...
	<table class="named-colors-table by-shade" >
	<thead><tr><td colspan="3">Gray colors</td><td><input type="text" placeholder="Color"></td></tr></thead>
	<tr>
